 ...
 * kitty, iTerm2, Zed, etc.
 *
 * Fires at the OS window level — not aware of tabs or panes within
 ...
 * Useful in tests between cases to clear the listener reference.
 */
 ...
 * Defaults to true before tracking starts (conservative — avoids false
 * notifications when focus state is unknown).
 */
